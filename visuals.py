...
def plot_trials(csv):
	...
	ax.set_title("%d-Trial Rolling Average Reward per Action"%(len(training_data)))
	...
	ax.set_title("%d-Trial Rolling Relative Frequency of Bad Actions"%(len(training_data)))
	...
	ax.set_title("%d-Trial Rolling Rate of Reliability"%(len(training_data)))
